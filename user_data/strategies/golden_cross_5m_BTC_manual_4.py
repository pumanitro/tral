...
class GoldenCross5mBTCManual(IStrategy):
    """
...
#     minimal_roi = { "0": 10000 }
    ...
    quick_sma_candles = IntParameter(10, 100, default=31, space="buy")
    slow_sma_candles = IntParameter(150, 250, default=177, space="buy")
